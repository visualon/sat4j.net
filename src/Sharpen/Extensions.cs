...
//			Encoding e = Encoding.GetEncoding (name, EncoderFallback.ExceptionFallback, DecoderFallback.ExceptionFallback);
		...
		internal static void Finish (this Inflater i)
		{
		}
		...
		internal static CharsetDecoder NewDecoder (this Encoding enc)
		{
			return new CharsetDecoder (enc);
		}

		internal static CharsetEncoder NewEncoder (this Encoding enc)
		{
		...
		internal static int GetTotalInFixed (this Inflater inf)
		{
			if (inf.TotalIn > 0)
		...
		internal static int GetRemainingInputFixed (this Inflater inf)
		{
