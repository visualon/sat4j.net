...
namespace Org.Sat4j.Minisat.Constraints
{
	...
	/// </author>
	[System.Serializable]
	public class CardinalityDataStructureYanMin : AbstractCardinalityDataStructure
	{
		...
		*/
		...
		{
			return MinWatchCard.MinWatchCardNew(this.solver, GetVocabulary(), literals, MinWatchCard.Atleast, 1);
		}
		...
		*/
		...
		{
			return MinWatchCard.MinWatchCardNew(this.solver, GetVocabulary(), literals, MinWatchCard.Atleast, degree);
		}

		public override Constr CreateUnregisteredCardinalityConstraint(IVecInt literals, int degree)
		{
			return new MinWatchCard(GetVocabulary(), literals, MinWatchCard.Atleast, degree);
		}
	}
}
